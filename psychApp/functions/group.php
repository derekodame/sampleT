...
while($row=mysqli_fetch_array($query)){
	...
	echo "<table  id='groupf'><tr  ><td id='bb'><div contenteditable='true'  style='width:80px; overflow-x: hidden;'>$c $age</div></td><td><div style='width:140px; overflow-x: hidden;' contenteditable='true'>$Stage_of_Change</div></td><td><div style='width:140px; overflow-x: hidden;' contenteditable='true'>$Symptoms_and_Disorders</div></td><td><div style='width:200px; overflow-x: hidden;' contenteditable='true'>$Psychological_Treatment</div></td><td> <div contenteditable='true' style='width:120px; overflow-x: hidden;'>$Evidence_Level</div></td><td><div style='width:500px; height:80px; overflow-x: hidden;' contenteditable='true'  contenteditable='true'>$Basis_for_Evidence </div></td><td  style=' border: 0px solid white; ' ><span id='xx' onclick='dele($id);' title='delete' >x</span></td</tr></table>";
